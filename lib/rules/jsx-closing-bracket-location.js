...
module.exports = function(context) {
  ...
  function hasCorrectLocation(tokens, expectedLocation) {
    switch (expectedLocation) {
      ...
      case 'line-aligned':
        ...
        return correctColumn === tokens.closingStartOfLine.column;
      default:
        return true;
    }
  }
  ...
  function getTokensLocations(node) {
    ...
    var closingLine = sourceCode.lines[closing.line - 1];
    var closingStartOfLine = {
      column: /^\s*/.exec(closingLine)[0].length,
      line: closing.line
    };
    return {
      tag: tag,
      ...
      closingStartOfLine: closingStartOfLine
    };
  }
